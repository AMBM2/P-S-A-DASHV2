  ...
  return (
    <>
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse 50% 40% at 18% 8%, rgba(99,102,241,0.28), transparent 60%)," +
            "radial-gradient(ellipse 45% 38% at 85% 12%, rgba(139,92,246,0.22), transparent 58%)," +
            "radial-gradient(ellipse 40% 35% at 60% 95%, rgba(14,165,233,0.18), transparent 60%)," +
            "radial-gradient(ellipse 55% 45% at 50% 50%, rgba(76,29,149,0.20), transparent 65%)",
        }}
      />
