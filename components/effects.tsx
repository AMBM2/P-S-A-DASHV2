...
/* ===================== AURORA BACKGROUND (gold) ===================== */
export function AuroraBackground({ className }: { className?: string }) {
  return (
    <div className={cn("pointer-events-none absolute inset-0 overflow-hidden", className)} aria-hidden>
      <div
        className="absolute -inset-[10%] animate-[aurora_18s_ease-in-out_infinite]"
        style={{
          background:
            "radial-gradient(ellipse 55% 45% at 18% -5%, rgba(234,179,8,0.14), transparent 60%)," +
            "radial-gradient(ellipse 45% 40% at 85% 8%, rgba(202,138,4,0.12), transparent 58%)," +
  ...
  return (
    <div
      className={cn(
        ...
        "bg-[radial-gradient(circle_at_30%_0%,rgba(234,179,8,0.4),transparent_45%)]",
        className
      )}
      style={{ boxShadow: `0 0 ${20 + intensity * 30}px -6px rgba(234,179,8,${0.22 * intensity})` }}
    >
